...
═══════════════════════════════════════════════════════ */
const services = [
  { image: '/images/servicio-carga-gas.jpg', title: 'Carga de Gas R134a y R1234yf', desc: 'Recarga con refrigerante puro certificado según la especificación de tu vehículo. Medición precisa por gramo.', link: '/servicios#carga-gas' },
  { image: '/images/servicio-detector-fugas.jpg', title: 'Detección y Reparación de Fugas', desc: 'Localización electrónica de alta sensibilidad. Sellado profesional con garantía de hermeticidad.', link: '/servicios#fugas' },
  { image: '/images/servicio-compresor.jpg', title: 'Reparación de Compresor', desc: 'Diagnóstico completo del compresor, cambio de embrague o reemplazo total con repuestos originales.', link: '/servicios#compresor' },
  { image: '/images/servicio-condensador.jpg', title: 'Reparación de Condensador y Evaporador', desc: 'Limpieza profesional, reparación de aletas o cambio completo del radiador de A/C.', link: '/servicios#condensador' },
  { image: '/images/servicio-sanitizacion.jpg', title: 'Sanitización contra Malos Olores', desc: 'Eliminación de bacterias, hongos y malos olores del sistema de ventilación con productos certificados.', link: '/servicios#sanitizacion' },
  { image: '/images/servicio-mantencion.jpg', title: 'Mantención Preventiva', desc: 'Revisión completa del sistema antes del verano. Previne fallas costosas y alarga la vida útil.', link: '/servicios#mantencion' },
]
          ...
          <Reveal className="lg:col-span-2 flex justify-center">
            <div className="relative">
              <div className="w-[300px] h-[380px] sm:w-[340px] sm:h-[420px] rounded-[50%_/_40%] p-[5px] bg-gradient-to-br from-brand-orange to-brand-blue">
                <img
                  src="/images/edinson-portrait.jpg"
...
═══════════════════════════════════════════════════════ */
const cases = [
  { image: '/images/caso-compresor.jpg', title: 'Compresor Reemplazado — Toyota Corolla 2019', problem: 'El A/C no enfriaba, ruido en el compresor', solution: 'Diagnóstico + cambio de compresor original', result: 'A/C Restaurado' },
  { image: '/images/caso-carga-gas.jpg', title: 'Carga de Gas — Nissan Qashqai 2021', problem: 'Pérdida progresiva de refrigerante', solution: 'Detección de fuga + recarga R134a', result: 'A/C Restaurado' },
  { image: '/images/servicio-sanitizacion.jpg', title: 'Sanitización — Hyundai Tucson 2020', problem: 'Malos olores al encender el A/C', solution: 'Sanitización antibacterial completa', result: 'Olor Eliminado' },
]
