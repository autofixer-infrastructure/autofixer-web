...
export const metadata: Metadata = {
  title: 'Recarga Gas R1234yf a Domicilio | desde $90.000 | Autofixer',
  description: 'Recarga de gas R1234yf a domicilio en Santiago en 1 hora. Tecnicos certificados, garantia 90 dias. Compatible con todos los modelos. WhatsApp +56 9 3507 5600.',
          ...
          <div className='max-w-3xl'>
            ...
            <div className='flex flex-col sm:flex-row gap-4'>
              <a
                ...
                className='inline-flex items-center justify-center gap-2 bg-green-700 hover:bg-green-600 text-white font-semibold px-8 py-4 rounded-lg transition-colors'
              >
