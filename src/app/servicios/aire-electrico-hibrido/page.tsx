        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <div className="flex flex-wrap gap-4">
              <a href="https://wa.me/56935075600?text=Hola%2C%20necesito%20servicio%20de%20A%2FC%20para%20mi%20vehiculo%20hibrido" className="inline-flex items-center gap-2 bg-amber-500 hover:bg-amber-600 text-white px-6 py-3 rounded-lg font-medium transition-colors">
          ...
          <div className="grid lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-xl p-6 mb-6 sticky top-6">
                ...
                <a href="https://wa.me/56935075600?text=Hola%2C%20necesito%20servicio%20A%2FC%20para%20mi%20hibrido" className="block w-full text-center bg-amber-500 hover:bg-amber-600 text-white px-6 py-3 rounded-lg font-medium mb-3 transition-colors">
      ...
      <section className="py-16 bg-gradient-to-br from-emerald-800 to-teal-800 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <a href="https://wa.me/56935075600?text=Hola%2C%20necesito%20servicio%20A%2FC%20para%20mi%20vehiculo%20hibrido" className="inline-flex items-center gap-2 bg-amber-500 hover:bg-amber-600 text-white px-8 py-4 rounded-lg font-medium text-lg transition-colors">
              <Phone className="w-5 h-5" />
              Solicitar Servicio
            </a>
      ...
      <div className="mt-12 p-6 bg-gray-50 rounded-xl border border-gray-100">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <a href="/servicios/diagnostico" className="block p-4 bg-white rounded-lg shadow-sm hover:shadow-md transition border border-gray-100">
            <h4 className="font-semibold text-blue-600 mb-1">Diagnostico Especializado</h4>
