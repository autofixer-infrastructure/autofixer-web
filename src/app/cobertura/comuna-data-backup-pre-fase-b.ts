...
export function getComunaInfo(slug: string): ComunaInfo | null {
  const data: Record<string, ComunaInfo> = {
    ...
    'independencia': {
      ...
      descripcion: 'Servicio de aire acondicionado automotriz a domicilio en Independencia. Atención en todo el sector norte de Santiago, incluyendo el Hospital Clínico y el Barrio Chino. Diagnóstico gratis si contratas.',
      seo: {
