    ...
    try {
      ...
      if (res.ok) {
        ...
        trackEvent('generate_lead', {
          ...
          service_slug: form.service || 'general',
          service_category: mapServiceToCategory(form.service || 'general'),
            ...
            <ScrollReveal>
              <div className='bg-gradient-to-br from-blue-900 to-indigo-900 rounded-2xl p-8 text-white'>
                ...
                <a
                  ...
                  className='mt-6 inline-flex items-center gap-2 bg-amber-700 hover:bg-amber-600 text-white px-6 py-3 rounded-lg font-medium transition-colors w-fit'
                >
