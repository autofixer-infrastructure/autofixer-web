export const metadata = {
  title: 'performance · Panel Autofixer',
};
...
export default function PerformancePage() {
  return (
    <div className="max-w-4xl mx-auto">
      <div className="mb-8">
        <h1 className="text-2xl md:text-3xl font-bold text-slate-900 dark:text-white capitalize">performance</h1>
      ...
      <div className="bg-white dark:bg-slate-900 rounded-2xl p-12 border border-slate-200 dark:border-slate-800 text-center">
        ...
        <p className="text-slate-500 dark:text-slate-400 max-w-md mx-auto">
          Esta sección estará disponible en el Sprint 38 con diagnósticos automatizados de performance.
